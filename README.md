...
Sollte Google Colab verwendet werden, dann muss zuerst der Ordner data angelegt werden und das Dokument dort hochgeladen werden. Siehe Schritt 09_nur_fuer_google_colab.
